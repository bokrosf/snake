...
magic_food_scene::magic_food_scene(int id)
    : scene(id)
{
}

void magic_food_scene::initialize()
{
    ...
    indicator.add_component<ability_indicator_renderer>().layer_order = render_layer::ability_indicator;
